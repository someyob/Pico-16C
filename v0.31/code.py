...
version_string = "Pico 16C v0.31"
release_string = "10 Dec 2022"
...
def print_status(Xreg, Yreg, Zreg, Treg, LastX, base, shift):
    print("\nT ", Treg)
    print("Z ", Zreg)
    print("Y ", Yreg)
    print("X ", Xreg)
...
def test_main():
    ...
    refresh_screen(calculator.Xreg, calculator.base, calculator.shift,
                                   calculator.strindex)
    print_status(calculator.Xreg, calculator.Yreg, calculator.Zreg, calculator.Treg,
                                 calculator.LastX, calculator.base, calculator.shift)
