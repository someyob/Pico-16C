...
key_functions = [ 'f_mathOp', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit',
 ...
 # shift f:                 
                  ...
                  'f_mathOp', 'f_undef', 'f_undef', 'f_undef', 'f_show_base', 'f_show_base', 'f_show_base', 'f_show_base', 'f_undef', 'f_undef',
                  'f_mathOp', 'f_undef', 'f_undef', 'f_undef', 'f_undef',     'f_undef',     'f_undef',     'f_undef',     'f_undef', 'f_undef',
                  'f_mathOp', 'f_undef', 'f_undef', 'f_undef', 'f_undef',     'f_undef',     'f_undef',     'f_shift',     'f_shift', 'f_ON',
 # shift g:                 
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_CLx',   'f_undef', 'f_rollu', 'f_undef', 'f_undef',
