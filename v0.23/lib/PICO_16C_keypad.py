...
key_functions = [ 'f_mathOp', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit', 'f_digit',
                  ...
                  'f_mathOp', 'f_digit', 'f_digit', 'f_digit', 'f_undef', 'f_BSP',   'f_XY',    'f_undef', 'f_undef', 'f_undef',
 ...
 # shift f:                 
                  ...
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_show_base', 'f_show_base', 'f_show_base', 'f_show_base', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',     'f_undef',     'f_undef',     'f_undef',     'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',     'f_undef',     'f_undef',     'f_shift',     'f_shift', 'f_ON',
 # shift g:                 
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_CLx',   'f_undef', 'f_undef', 'f_undef', 'f_undef',
                  'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_undef', 'f_pan_d', 'f_pan_d', 'f_shift', 'f_shift', 'f_ON']
...
class Calculator():
    ...
    def f_show_base(self, key):
        print(self.name + ' f_show_base ' + str(key))
